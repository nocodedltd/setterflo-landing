    ...
    <div className="glass rounded-2xl p-8 border border-border">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-text-secondary">
          Continue automating your Instagram DMs
        </p>
      </div>
      ...
      <form onSubmit={handleLogin} className="space-y-5">
        ...
        <div className="relative">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-4 bg-background-secondary text-text-muted">or continue with email</span>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between text-sm">
          <label className="flex items-center cursor-pointer">
            <input
              type="checkbox"
              className="w-4 h-4 rounded border-border bg-background-secondary text-primary focus:ring-primary/50 focus:ring-offset-0"
            />
            <span className="ml-2 text-text-secondary">Remember me</span>
          </label>
          <Link href="/forgot-password" className="text-primary hover:text-primary-400 font-medium transition-colors">
            Forgot password?
          </Link>
        </div>
